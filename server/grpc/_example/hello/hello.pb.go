...
func (c *helloClient) SayHello(ctx context.Context, in *SayHelloReq, opts ...grpc.CallOption) (*SayHelloRsp, error) {
	out := new(SayHelloRsp)
...
func (*UnimplementedHelloServer) SayHello(context.Context, *SayHelloReq) (*SayHelloRsp, error) {
